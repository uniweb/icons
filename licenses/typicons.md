...
- **Source**: http://s-ings.com/typicons/
- **License**: CC BY-SA 3.0
- **Family code**: `ti`
- **Attribution: REQUIRED — and this one is SHARE-ALIKE**

> ⚠️ **The only share-alike licence in this package.** CC BY-SA is materially stricter than the
> CC BY families (`fa`, `fa6`, `gi`, `vsc`, `im`): adaptations must be released under the same
> licence.
...
Copyright (c) Stephen Hutchings.

- **Attribution required** — credit the author, link the licence, note any changes.
- **ShareAlike** — if you remix, transform or build upon the icons, you must distribute your
...
```
Typicons by Stephen Hutchings — CC BY-SA 3.0 (https://creativecommons.org/licenses/by-sa/3.0/)
```
